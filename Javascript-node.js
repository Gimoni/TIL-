...
// 실제 사용에서 비동기 함수 다음작업이 먼저 실행 될 수 있도록... 블로킹을 방지하는게 목적.
...
// async function 을 사용해서 인스턴스 만들기
...
// console.log(f()) // 상태: rejecked, 결과값: 'bar' Uncaught (in promise) bar
...
// // promise 객체를 사용하여 서버에 데이터를 요청한다.
// fetchData() // Promise 객체는 비동기적으로 작동한다.
// .then(data => { // 데이터를 처리 promise 사용에 then method 사용. 
//     console.log(data)
// }) 
...
//## JSON
// JavaScript Objedt Notation (JavaScript 객체 표기법)
// JavaScript 객체를 저장하거나 진솔하기 위한 텍스트 포맷

// const o = {foo: "bar"}
// const json = '{"foo": "bar"}'

// console.log(o) // Object
// console.log(json) // JSON Format (text)
// console.log(typeof json) // string

// const o = {foo: "bar"}
// // JSON.stringify(Object)) : Object를 JSON format으로 변환한다
// const r = JSON.stringify(o)

// console.log(r)

// const json = '{"foo" : "bar"}'
// // JSON.parse(json) : JSON format을 Object로 변환한다
